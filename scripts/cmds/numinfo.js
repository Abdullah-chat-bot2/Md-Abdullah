...
module.exports = {
        ...
        langs: {
                bn: {
                        noNumber: "• বেবি, নাম্বার দাও! উদাহরণ: {pn} 01823339492",
                        invalid: "❌ নাম্বারটি সঠিক নয়!",
                        error: "❌ An error occurred: contact ÃBDÜLLÄH %1\n•WhatsApp: 01823339492",
                        success: "📱 নাম্বারের তথ্য:\n\n• নাম: %1\n• নাম্বার: %2\n• ফেসবুক আইডি: %3"
                },
                en: {
                        noNumber: "• Baby, provide a number. Example: {pn} 01823339492",
                        invalid: "❌ Invalid number format!",
                        error: "❌ An error occurred: contact ÃBDÜLLÄH %1\n•WhatsApp: 01823339492",
                        success: "📱 Number Info:\n\n• Name: %1\n• Number: %2\n• FB ID: %3"
                },
                vi: {
                        noNumber: "• Cưng ơi, hãy cung cấp số điện thoại. Ví dụ: {pn} 01823339492",
