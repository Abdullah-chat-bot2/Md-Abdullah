...
module.exports = {
        ...
        langs: {
                bn: {
                        ...
                        error: "× এডিট করতে সমস্যা হয়েছে: %1। প্রয়োজনে Contact ÃBDÜLLÄH।"
                },
                en: {
                        ...
                        error: "× Failed to edit: %1. Contact ÃBDÜLLÄH for help."
                },
                vi: {
                        ...
                        error: "× Lỗi chỉnh sửa: %1. Liên hệ ÃBDÜLLÄH để hỗ trợ."
                }
        },
